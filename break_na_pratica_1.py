...
# a menos que o usuário insira "chupacabra" como a palavra de saída secreta, caso em que a mensagem "Você saiu do loop com sucesso". 
# Deve ser impresso na tela, e o loop deve terminar. Não imprima nenhuma das palavras inseridas pelo usuário. 
# Use o conceito de execução condicional e a declaração break.

while True:
    palavra_inserida = input("Digite uma palavra: ")

    if palavra_inserida == "chupacabra":
        break
